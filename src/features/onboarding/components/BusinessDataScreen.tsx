...
const styles = {
  ...
  description: { color: colors.foreground, fontFamily: 'DMSans-Regular', fontSize: 16 },
  form: { gap: 24 },
  field: { gap: 8 },
  ...
  radioLabel: { color: colors.foreground, flex: 1, fontFamily: 'DMSans-Regular', fontSize: 16 },
