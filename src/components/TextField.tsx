...
const styles = {
  ...
  input: { backgroundColor: '#27272A', borderColor: colors.border, borderRadius: 12, borderWidth: 1, color: colors.foreground, fontFamily: 'DMSans-Medium', fontSize: 16, height: 48, paddingHorizontal: spacing.control },
